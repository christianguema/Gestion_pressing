<div class="modal fade" id="deletefacturation" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" id="deleteprojectLabel">Supprimer le type</h5>
            ...
            <div class="modal-footer">
                ...
                <form id="deletefacturationForm" action="" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')
