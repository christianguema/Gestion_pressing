...
\begin{minipage}{0.5\textwidth}
    ...
    \textbf{N°}: @latex($commande->commande_id)\\
    \textbf{Date}: @latex(date('d/m/Y', strtotime($commande->date_reception)))
\end{minipage}
...
\begin{flushright}
    \begin{tabular}{lr}
        ...
        @endif
        \hline
        \textbf{\color{lightblue}Net à Payer:} & \textbf{@latex(number_format($commande->montant_total - ($montant_remise ?? 0), 0, ',', ' '))} FCFA
    \end{tabular}
\end{flushright}
