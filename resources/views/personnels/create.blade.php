            ...
            <div class="card-body">
              ...
              <form method="POST" action="{{ route('personnels.store') }}"  enctype="multipart/form-data" class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="tel" class="form-control @error('contact') is-invalid @enderror" name="contact" id="contact" value="{{ old('contact') }}">
                    @error('contact')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="file"
                        class="form-control @error('profilImage') is-invalid @enderror"
                        id="profilImage"
                        name="profilImage"
                        accept="image/*">
                    @error('profilImage')
                ...
                <div class="col-md-6">
                    ...
                    <select id="pressing_id" class="form-select @error('pressing_id') is-invalid @enderror" name="pressing_id" required>
