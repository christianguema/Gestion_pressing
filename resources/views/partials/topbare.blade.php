<div class="d-flex align-items-center justify-content-between">
    <a href="#" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">PressingMaNaGer</span>
    </a>
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
                <li class="dropdown-header">
                    ...
                    <a href="#"><span class="p-2 badge rounded-pill bg-primary ms-2">Tous lire</span></a>
                </li>
                <li>
...
<script>
    document.getElementById('logout-link').addEventListener('click', function(event) {
        ...
        document.getElementById('logout-form').submit(); // Soumet le formulaire pour se déconnecter
    });
</script>
<!-- End Header -->
