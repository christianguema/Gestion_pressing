...
class TypePrestationController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->back()->with('success', 'Type de prestation ajouté avec succès.');
    }
    ...
    public function update(Request $request, TypePrestation $typePrestation): RedirectResponse
    {
        ...
        return redirect()->back()->with('success', 'Type de prestation mis à jour.');
    }
    ...
    public function destroy(TypePrestation $typePrestation)
    {
        ...
        return redirect()->back()->with('success', 'Type de prestation supprimé.');
    }
}
